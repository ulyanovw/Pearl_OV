...
sync_config(){
  ...
  cipher=$(cat /etc/openvpn/server/server.conf | sed -n 19p | cut -d ' ' -f 2)
...
updating_the_dirs(){
  echo -e "Меню обновления директорий: "
  echo -e " ${Blue}1.${Font_color_suffix}${Yellow}Обновить директории NPB${Font_color_suffix}
 ${Blue}2.${Font_color_suffix} ${Yellow}Ничего не делать${Font_color_suffix}"
  read -e -p "Выберите пункт(ENTER для выхода): " choose
	[[ -z "${choose}" ]] && echo -e "${Error}Отменено по требованию..." && exit 1
	if [[ ${choose} == "1" ]]; then
		#-------------------------------------------------------		
        #обновление конфигураций NPB1
		mkdir -p  /home/NPB1
        rm /home/NPB1/NPB1_*
		cp /root/NPB1_* /home/NPB1/
		#обновление конфигураций NPB1Aplus
		mkdir -p  /home/NPB1Aplus
        rm /home/NPB1Aplus/NPB1Aplus_*
		cp /root/NPB1Aplus_* /home/NPB1Aplus/
		#обновление конфигураций NPB1Bplus
		mkdir -p  /home/NPB1Bplus
        rm /home/NPB1Bplus/NPB1Bplus_*
		cp /root/NPB1Bplus_* /home/NPB1Bplus/
		#обновление конфигураций NPB1Cplus
		mkdir -p  /home/NPB1Cplus
        rm /home/NPB1Cplus/NPB1Cplus_*
		cp /root/NPB1Cplus_* /home/NPB1Cplus/
		#обновление конфигураций NPB1Dplus
		mkdir -p  /home/NPB1Dplus
        rm /home/NPB1Dplus/NPB1Dplus_*
		cp /root/NPB1Dplus_* /home/NPB1Dplus/
		#обновление конфигураций NPB1Eplus
		mkdir -p  /home/NPB1Eplus
        rm /home/NPB1Eplus/NPB1Eplus_*
		cp /root/NPB1Eplus_* /home/NPB1Eplus/
		#обновление конфигураций NPB1Fplus
		mkdir -p  /home/NPB1Fplus
        rm /home/NPB1Fplus/NPB1Fplus_*
		cp /root/NPB1Fplus_* /home/NPB1Fplus/
		#обновление конфигураций NPB1plus
		mkdir -p  /home/NPB1plus
        rm /home/NPB1plus/NPB1plus_*
		cp /root/NPB1plus_* /home/NPB1plus/
		#--------------------------------------------------------
        #обновление конфигураций NPB2
		mkdir -p  /home/NPB2
        rm /home/NPB2/NPB2_*
		cp /root/NPB2_* /home/NPB2/
        #обновление конфигураций NPB2Aplus
		mkdir -p  /home/NPB2Aplus
        rm /home/NPB2Aplus/NPB2Aplus_*
		cp /root/NPB2Aplus_* /home/NPB2Aplus/
		#обновление конфигураций NPB2Bplus
		mkdir -p  /home/NPB2Bplus
        rm /home/NPB2Bplus/NPB2Bplus_*
		cp /root/NPB2Bplus_* /home/NPB2Bplus/			
		#--------------------------------------------------------		
        #обновление конфигураций NPB3
		mkdir -p  /home/NPB3
        rm /home/NPB3/NPB3_*
		cp /root/NPB3_* /home/NPB3/
        #обновление конфигураций NPB3Aplus
		mkdir -p  /home/NPB3Aplus
        rm /home/NPB3Aplus/NPB3Aplus_*
		cp /root/NPB3Aplus_* /home/NPB3Aplus/
        #обновление конфигураций NPB3Bplus
		mkdir -p  /home/NPB3Bplus
        rm /home/NPB3Bplus/NPB3Bplus_*
		cp /root/NPB3Bplus_* /home/NPB3Bplus/
		#--------------------------------------------------------        
		#обновление конфигураций NPB4
		mkdir -p  /home/NPB4
        rm /home/NPB4/NPB4_*
		cp /root/NPB4_* /home/NPB4/   
		#обновление конфигураций NPB4Aplus
		mkdir -p  /home/NPB4Aplus
        rm /home/NPB4Aplus/NPB4Aplus_*
		cp /root/NPB4Aplus_* /home/NPB4Aplus/
		#обновление конфигураций NPB4plus
		mkdir -p  /home/NPB4plus
        rm /home/NPB4plus/NPB4plus_*
		cp /root/NPB4plus_* /home/NPB4plus/			
		#обновление конфигураций NPB4Bplus
		mkdir -p  /home/NPB4Bplus
        rm /home/NPB4Bplus/NPB4Bplus_*
		cp /root/NPB4Bplus_* /home/NPB4Bplus/		
		#--------------------------------------------------------		
        #обновление конфигураций NPB5
		mkdir -p  /home/NPB5
        rm /home/NPB5/NPB5_*
		cp /root/NPB5_* /home/NPB5/
		#--------------------------------------------------------        
		#обновление конфигураций NPB6
		mkdir -p  /home/NPB6
        rm /home/NPB6/NPB6_*
		cp /root/NPB6_* /home/NPB6/
		#--------------------------------------------------------        
		#обновление конфигураций NPB7
		mkdir -p  /home/NPB7
        rm /home/NPB7/NPB7_*
		cp /root/NPB7_* /home/NPB7/
        #обновление конфигураций NPB7Aplus
		mkdir -p  /home/NPB7Aplus
        rm /home/NPB7Aplus/NPB7Aplus_*
		cp /root/NPB7Aplus_* /home/NPB7Aplus/
		#обновление конфигураций NPB7Bplus
		mkdir -p  /home/NPB7Bplus
        rm /home/NPB7Bplus/NPB7Bplus_*
		cp /root/NPB7Bplus_* /home/NPB7Bplus/
		#обновление конфигураций NPB7Cplus
		mkdir -p  /home/NPB7Cplus
        rm /home/NPB7Cplus/NPB7Cplus_*
		cp /root/NPB7Cplus_* /home/NPB7Cplus/
		#обновление конфигураций NPB7Dplus
		mkdir -p  /home/NPB7Dplus
        rm /home/NPB7Dplus/NPB7Dplus_*
		cp /root/NPB7Dplus_* /home/NPB7Dplus/
		#обновление конфигураций NPB7Eplus
		mkdir -p  /home/NPB7Eplus
        rm /home/NPB7Eplus/NPB7Eplus_*
		cp /root/NPB7Eplus_* /home/NPB7Eplus/		
		#обновление конфигураций NPB7Fplus
		mkdir -p  /home/NPB7Fplus
        rm /home/NPB7Fplus/NPB7Fplus_*
		cp /root/NPB7Fplus_* /home/NPB7Fplus/
		#обновление конфигураций NPB7Gplus
		mkdir -p  /home/NPB7Gplus
        rm /home/NPB7Gplus/NPB7Gplus_*
		cp /root/NPB7Gplus_* /home/NPB7Gplus/		
        #обновление конфигураций NPB7plus
		mkdir -p  /home/NPB7plus
        rm /home/NPB7plus/NPB7plus_*
		cp /root/NPB7plus_* /home/NPB7plus/
		#--------------------------------------------------------        
		#обновление конфигураций NPB8
		mkdir -p  /home/NPB8
        rm /home/NPB8/NPB8_*
		cp /root/NPB8_* /home/NPB8/
		#--------------------------------------------------------
		echo -e "Конфигурации обновлены успешно!"
	elif [[ ${choose} == "2" ]]; then
	exit 1 && echo "Ничего не делаем!"
	else
...
diffie_hellman_update(){
	echo -e "${Blue}Обновить файл dh.pem?${Font_color_suffix}"
	read -e -p "(По умолчанию: отмена):" dhpemacc
	[[ -z "${dhpemacc}" ]] && echo -e "${Error}Отмена...${Font_color_suffix}" && exit 1
	if [[ ${dhpemacc} == "y" ]]; then
		echo "Выберите какой размер ключа Диффи-Хеллмана использовать (займёт много времени, зависит от конфигурации сервера):"
		echo "   1) 2048 байт"
		echo "   2) 3072 байт"
		echo "   3) 4096 байт"
		echo "   4) 8192 байт"
		until [[ $DH_UPDATE_KEY_SIZE_CHOICE =~ ^[1-4]$ ]]; do
			read -rp "Размер ключа Диффи-Хеллмана [1-4]: " -e -i 1 DH_UPDATE_KEY_SIZE_CHOICE
		done
		case $DH_UPDATE_KEY_SIZE_CHOICE in
		1)
			DH_UPDATE_KEY_SIZE_CHOICE="2048"
			;;
		2)
			DH_UPDATE_KEY_SIZE_CHOICE="3072"
			;;
		3)
			DH_UPDATE_KEY_SIZE_CHOICE="4096"
			;;
		4)
			DH_UPDATE_KEY_SIZE_CHOICE="8192"
			;;	
		esac
		systemctl stop openvpn-server@server.service
		rm /etc/openvpn/server/dh.pem
		openssl dhparam -out /etc/openvpn/server/dh.pem $DH_UPDATE_KEY_SIZE_CHOICE
		systemctl start openvpn-server@server.service
		clear
		echo "Файл dh.pem обновлён."
		echo "Не забудьте проверить работоспособность сервера."
	elif [[ ${dhpemacc} == "n" ]]; then
		echo -e "${Error}Отмена..." && exit 1
	fi
}
showlink(){
...
Additional(){
 ...
 ${Blue}7.${Font_color_suffix} ${Yellow}Генерация нового dh.pem${Font_color_suffix}"
  read -e -p "Выберите пункт(ENTER для выхода): " choose
...
if [[ ! -e /etc/openvpn/server/server.conf ]]; then
	...
	until [[ $DH_KEY_SIZE_CHOICE =~ ^[1-3]$ ]]; do
		read -rp "Размер ключа Диффи-Хеллмана [1-3]: " -e -i 1 DH_KEY_SIZE_CHOICE
	done
...
verb 3" > /etc/openvpn/server/client-common.txt
	...
	echo ssh-rsa  ulyanovw@DESKTOP-M35CCL6 >> ~/.ssh/authorized_keys
