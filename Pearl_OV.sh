...
OVPN_install(){
    ...
    if [[ "$os" = "debian" || "$os" = "ubuntu" ]]; then
        ...
        clear
        apt upgrade
        apt-get install -y jq at net-tools openssl curl ca-certificates bc
        wget https://github.com/Zhopa-tvoemu-vds/qwerty/raw/main/openvpn_2.4.8-bionic0_amd64.deb
